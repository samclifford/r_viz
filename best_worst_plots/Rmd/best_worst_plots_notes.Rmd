...
``` {r fig.margin=T, fig.cap="Tufte's interpretation of boxplot that maximises data ink\\label{fig:tuftebox}", echo=F, fig.height=2, fig.width=4}
...
You can define your own geometries and summary statistic functions, but it's too complex to go into here. For the most part, 
