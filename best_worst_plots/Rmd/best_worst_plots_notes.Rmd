...
``` {r fig.margin=T, echo=F, fig.cap="Fuel efficiency mapped to colour and y coordinate. Gradated pattern of colour implies there's another relationship with fuel efficiency being looked at.\\label{fig:2mpg}", fig.height=4, fig.width=6}
data(mtcars)
...
``` {r fig.margin=T, fig.cap='Standard boxplot\\label{fig:ggbox}', echo=F}
data(mtcars)
...
``` {r fig.margin=T, fig.cap="Tufte's interpretation of boxplot that maximises data ink\\label{fig:tuftebox}", echo=F, fig.height=1.5, fig.width=4}
